    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background-color: #e0e0e0; /* Lebih gelap supaya kontras */
            display: flex;
        ...
        .form-container {
            ...
            padding: 40px;
            border-radius: 16px;
            box-shadow: 0 16px 40px rgba(0, 0, 0, 0.25); /* shadow besar agar menonjol */
            width: 100%;
            max-width: 420px;
...
<div class="form-container">
    ...
    <form method="POST" action="index.php?action=register">
        ...
        <?php if (!empty($error['confirm'])) echo "<div class='error'>{$error['confirm']}</div>"; ?>
